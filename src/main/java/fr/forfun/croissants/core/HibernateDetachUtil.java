 ...
 * <p/>
 * The original class was modified in two ways:
 * #1   The setting of fields was not really working well with regard to parent fields. The set field was modified
 * to use the ReflectionUtils.findField method to address this.
 * <p/>
 * #2   In the original, if a hibernate collection were not initialized, this class would set the instance variable
 * to null. This was problematic for us as we require empty collections on our objects instead of null.
 *
 * @author Greg Hinkle
...
public class HibernateDetachUtil {
    ...
    /**
     * Only process classes in this package tree
     */
    private static final String PACKAGE_PREFIX = "com.oa";
 
    /**
     * Change this to true if you want to null out uninitialized collections
     */
    private static final boolean SET_UNINITIALIZED_COLLECTIONS_TO_NULL = false;
    ...
    private static void nullOutUninitializedFields(Object value, Map<Integer, Object> checkedObjectMap,
        ...
        if (value instanceof Object[]) {
            ...
            collection
                    .addAll(replacementItems); // watch out! if this collection is a Set, HashMap$MapSet doesn't support addAll. See BZ 688000
    ...
    private static void nullOutFieldsByFieldAccess(Object object, Map<Integer, Object> checkedObjects,
        ...
        while (tmpClass != null && tmpClass != Object.class) {
            ...
            for (Field declaredField : declaredFields) {
                ...
                if (!((Modifier.isFinal(modifiers) && Modifier.isStatic(modifiers)) || Modifier
        ...
        for (Field field : classFields) {
            ...
            if (fieldValue instanceof HibernateProxy) {
                ...
                if (fieldValue instanceof AbstractPersistentCollection) {
                    ...
                    if (!((AbstractPersistentCollection) fieldValue).wasInitialized()) {
                        Object replacement = null;
                        if (!SET_UNINITIALIZED_COLLECTIONS_TO_NULL){
                	...
                	if (fieldValue != null
                            ...
                            .contains(PACKAGE_PREFIX) || fieldValue instanceof Collection
                	...
                	} else if(isDomainObject(fieldValue)){
                		//Debut Ajout
                		//Permet de gerer les objets imbriques non Hibernate Proxy mais contenant des objets non initialises
                		nullOutUninitializedFields((fieldValue), checkedObjects, checkedObjectCollisionMap, depth + 1, serializationType);
                		//Fin Ajout
                	}
                }
    ...
    private static void nullOutField(Object value, String fieldName) {
        try {
            Field f = ReflectionUtils.findField(value.getClass(), fieldName);
            if (f != null) {
                // try to set the field this way
                f.setAccessible(true);
                f.set(value, null);
